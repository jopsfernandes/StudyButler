  ...
  return (
    <ThemeProvider defaultTheme="dark" storageKey="vite-ui-theme">
     ...
     <nav className="grid items-start px-2 text-sm font-medium lg:px-4">
       <Link to="/user-dashboard/dashboard"  className="flex items-center gap-3 rounded-lg px-3 py-2 text-muted-foreground transition-all hover:text-primary dark:hover:bg-zinc-700">
         <Home className="h-5 w-5" />
         Dashboard
       </Link>
       <Link to="/user-dashboard" className="flex items-center gap-3 rounded-lg px-3 py-2 text-muted-foreground transition-all text-primary dark:hover:bg-zinc-800 dark:bg-zinc-900">
       ...
       <Link to="/user-dashboard/user-question-extractor" className="flex items-center gap-3 rounded-lg bg-muted px-3 py-2 text-primary transition-all hover:text-primary dark:hover:bg-zinc-800">
